package edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.snapshot;
...
public enum StructuralPartType implements edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.StructuralPartType {
    ...
    Uses_Concept( "https://ontology.mayo.edu/taxonomies/KAO/Rel/StructuralRelType#57ab3dbe-c6d8-3485-abad-41214d740e0f", "57ab3dbe-c6d8-3485-abad-41214d740e0f", "uses-concept", java.util.Arrays.asList( "uses-concept" ), "uses concept", "https://www.omg.org/spec/API4KP/api4kp/uses-concept",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.snapshot.StructuralPartType.Has_Part,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.snapshot.StructuralPartType.Has_Part,  } ) , 
    ...
    Leverages( "https://ontology.mayo.edu/taxonomies/KAO/Rel/StructuralRelType#841df031-fd83-3e4b-91da-3bb97cd0dd0b", "841df031-fd83-3e4b-91da-3bb97cd0dd0b", "leverages", java.util.Arrays.asList( "leverages" ), "leverages", "https://www.omg.org/spec/API4KP/api4kp/leverages",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.snapshot.StructuralPartType.Uses_Concept,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.snapshot.StructuralPartType.Uses_Concept,  edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.snapshot.StructuralPartType.Has_Part,  } ) , 
    ...
    Defines_In_Terms_Of( "https://ontology.mayo.edu/taxonomies/KAO/Rel/StructuralRelType#3ea88319-201c-361d-b5fd-f456a23668fb", "3ea88319-201c-361d-b5fd-f456a23668fb", "defines-in-terms-of", java.util.Arrays.asList( "defines-in-terms-of" ), "defines-in-terms-of", "https://www.omg.org/spec/API4KP/api4kp/defines-in-terms-of",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.snapshot.StructuralPartType.Leverages,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.snapshot.StructuralPartType.Uses_Concept,  edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.snapshot.StructuralPartType.Has_Part,  edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.snapshot.StructuralPartType.Leverages,  } ) , 
    ...
    Defines( "https://ontology.mayo.edu/taxonomies/KAO/Rel/StructuralRelType#e5ce0278-0309-3c37-ae63-626f7fc5c76b", "e5ce0278-0309-3c37-ae63-626f7fc5c76b", "defines", java.util.Arrays.asList( "defines" ), "defines", "https://www.omg.org/spec/API4KP/api4kp/defines",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.snapshot.StructuralPartType.Captures,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.snapshot.StructuralPartType.Uses_Concept,  edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.snapshot.StructuralPartType.Has_Part,  edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.snapshot.StructuralPartType.Captures,  } ) , 
    ...
    Embeds_Language( "https://ontology.mayo.edu/taxonomies/KAO/Rel/StructuralRelType#a1180655-792c-3db6-be8f-a9e7c79c126e", "a1180655-792c-3db6-be8f-a9e7c79c126e", "embedsLanguage", java.util.Arrays.asList( "embedsLanguage" ), "embeds language", "https://www.omg.org/spec/API4KP/api4kp/embedsLanguage",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.snapshot.StructuralPartType.Has_Proper_Part,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.snapshot.StructuralPartType.Has_Part,  edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.snapshot.StructuralPartType.Has_Proper_Part,  } ) , 
   
    /* has structural component */
    ...
    Has_Structural_Component( "https://ontology.mayo.edu/taxonomies/KAO/Rel/StructuralRelType#04a04cc9-ffc9-3916-96e6-5c928a06a627", "04a04cc9-ffc9-3916-96e6-5c928a06a627", "has-structural-component", java.util.Arrays.asList( "has-structural-component" ), "has structural component", "https://www.omg.org/spec/API4KP/api4kp/has-structural-component",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.snapshot.StructuralPartType.Has_Proper_Part,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.snapshot.StructuralPartType.Has_Part,  edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.snapshot.StructuralPartType.Has_Proper_Part,  } ) , 
    ...
    Structurally_Organized_By( "https://ontology.mayo.edu/taxonomies/KAO/Rel/StructuralRelType#857c1e6e-b1be-3def-bb4e-c188663c1595", "857c1e6e-b1be-3def-bb4e-c188663c1595", "structurally-organized-by", java.util.Arrays.asList( "structurally-organized-by" ), "structurally organized by", "https://www.omg.org/spec/API4KP/api4kp/structurally-organized-by",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.snapshot.StructuralPartType.Has_Structural_Component,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.snapshot.StructuralPartType.Has_Part,  edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.snapshot.StructuralPartType.Has_Structural_Component,  edu.mayo.ontology.taxonomies.kao.rel.structuralreltype.snapshot.StructuralPartType.Has_Proper_Part,  } ) 
   ;
  ...
  public static final URIIdentifier schemeURI = Series.toVersion(
      ...
      URI.create("https://ontology.mayo.edu/taxonomies/KAO/Rel/StructuralRelType/SNAPSHOT/"));

  public static final NamespaceIdentifier namespace = new NamespaceIdentifier()
      .withId(URI.create("https://ontology.mayo.edu/taxonomies/KAO/Rel/StructuralRelType/SNAPSHOT/"))
