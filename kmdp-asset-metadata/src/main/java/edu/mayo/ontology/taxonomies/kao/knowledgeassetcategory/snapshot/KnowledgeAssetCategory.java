package edu.mayo.ontology.taxonomies.kao.knowledgeassetcategory.snapshot;
...
public enum KnowledgeAssetCategory implements edu.mayo.ontology.taxonomies.kao.knowledgeassetcategory.KnowledgeAssetCategory {
    ...
    /* At its essence, knowledge of this kind is expressed using &quot;IF..DO..&quot; rules, usually by means of constraint-oriented languages with ECA and/or deontic aspects */
    ...
    /* The knowledge pertains specifically to the orchestration of the activities in relation to the goals, but usually relies on more ontologic, foundational definitions of the tasks to be performed as part of the process (as well as their related participants, roles, resources, etc.) */
  ...
  public static final URIIdentifier schemeURI = Series.toVersion(
      ...
      URI.create("https://ontology.mayo.edu/taxonomies/KAO/KnowledgeAssetCategory/SNAPSHOT/"));

  public static final NamespaceIdentifier namespace = new NamespaceIdentifier()
      .withId(URI.create("https://ontology.mayo.edu/taxonomies/KAO/KnowledgeAssetCategory/SNAPSHOT/"))
  ...
  public static class JsonSerializer extends edu.mayo.kmdp.terms.adapters.json.URITermsJsonAdapter.Serializer<KnowledgeAssetCategory> {}

  public static class JsonDeserializer extends edu.mayo.kmdp.terms.adapters.json.URITermsJsonAdapter.Deserializer<KnowledgeAssetCategory> {
