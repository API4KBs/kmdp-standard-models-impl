package edu.mayo.ontology.taxonomies.kao.rel.relatedversiontype.snapshot;
...
public enum RelatedVersionType implements edu.mayo.ontology.taxonomies.kao.rel.relatedversiontype.RelatedVersionType {
    ...
    Has_Next_Version( "https://ontology.mayo.edu/taxonomies/KAO/Rel/RelatedVersionType#f9213036-1c02-342c-90be-3b26b64bb094", "f9213036-1c02-342c-90be-3b26b64bb094", "has-next-version", java.util.Arrays.asList( "has-next-version" ), "has next version", "https://www.omg.org/spec/API4KP/api4kp/has-next-version",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.relatedversiontype.snapshot.RelatedVersionType.Has_Successor_Version,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.relatedversiontype.snapshot.RelatedVersionType.Has_Successor_Version,  } ) , 
    ...
    Has_Next_Immediate_Versioned_Revision( "https://ontology.mayo.edu/taxonomies/KAO/Rel/RelatedVersionType#bb62f55f-6808-3b7c-bb70-1b3281fd3c1a", "bb62f55f-6808-3b7c-bb70-1b3281fd3c1a", "has-next-immediate-versioned-revision", java.util.Arrays.asList( "has-next-immediate-versioned-revision" ), "has next immediate versioned revision", "https://www.omg.org/spec/API4KP/api4kp/has-next-immediate-versioned-revision",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.relatedversiontype.snapshot.RelatedVersionType.Has_Next_Version,  edu.mayo.ontology.taxonomies.kao.rel.relatedversiontype.snapshot.RelatedVersionType.Has_Later_Versioned_Revision,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.relatedversiontype.snapshot.RelatedVersionType.Has_Successor_Version,  edu.mayo.ontology.taxonomies.kao.rel.relatedversiontype.snapshot.RelatedVersionType.Has_Next_Version,  edu.mayo.ontology.taxonomies.kao.rel.relatedversiontype.snapshot.RelatedVersionType.Has_Later_Versioned_Revision,  } ) , 
    ...
    Has_Latest( "https://ontology.mayo.edu/taxonomies/KAO/Rel/RelatedVersionType#c52fba66-5ca4-3f3d-b7f6-7012a02e64c0", "c52fba66-5ca4-3f3d-b7f6-7012a02e64c0", "has-latest", java.util.Arrays.asList( "has-latest" ), "has latest", "https://www.omg.org/spec/API4KP/api4kp/has-latest",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.relatedversiontype.snapshot.RelatedVersionType.Has_Later_Versioned_Revision,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.relatedversiontype.snapshot.RelatedVersionType.Has_Successor_Version,  edu.mayo.ontology.taxonomies.kao.rel.relatedversiontype.snapshot.RelatedVersionType.Has_Later_Versioned_Revision,  } ) , 
    ...
    Has_Previous_Version( "https://ontology.mayo.edu/taxonomies/KAO/Rel/RelatedVersionType#278b9dcc-a102-3fdf-ad32-624b971dac7e", "278b9dcc-a102-3fdf-ad32-624b971dac7e", "has-previous-version", java.util.Arrays.asList( "has-previous-version" ), "has previous version", "https://www.omg.org/spec/API4KP/api4kp/has-previous-version",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.relatedversiontype.snapshot.RelatedVersionType.Has_Prior_Version,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.relatedversiontype.snapshot.RelatedVersionType.Has_Prior_Version,  } ) , 
    ...
    Has_Original( "https://ontology.mayo.edu/taxonomies/KAO/Rel/RelatedVersionType#a1acdddf-7045-39e8-977a-a5a40ed92eec", "a1acdddf-7045-39e8-977a-a5a40ed92eec", "has-original", java.util.Arrays.asList( "has-original" ), "has original", "https://www.omg.org/spec/API4KP/api4kp/has-original",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.relatedversiontype.snapshot.RelatedVersionType.Is_Later_Versioned_Revision_Of,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.relatedversiontype.snapshot.RelatedVersionType.Has_Prior_Version,  edu.mayo.ontology.taxonomies.kao.rel.relatedversiontype.snapshot.RelatedVersionType.Is_Later_Versioned_Revision_Of,  } ) , 
    ...
    Is_Immediate_Next_Versioned_Revision_Of( "https://ontology.mayo.edu/taxonomies/KAO/Rel/RelatedVersionType#e8c9e53c-b211-362b-bed8-b2144821a266", "e8c9e53c-b211-362b-bed8-b2144821a266", "is-immediate-next-versioned-revision-of", java.util.Arrays.asList( "is-immediate-next-versioned-revision-of" ), "is immediate next versioned revision of", "https://www.omg.org/spec/API4KP/api4kp/is-immediate-next-versioned-revision-of",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.relatedversiontype.snapshot.RelatedVersionType.Has_Previous_Version,  edu.mayo.ontology.taxonomies.kao.rel.relatedversiontype.snapshot.RelatedVersionType.Is_Later_Versioned_Revision_Of,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.relatedversiontype.snapshot.RelatedVersionType.Has_Prior_Version,  edu.mayo.ontology.taxonomies.kao.rel.relatedversiontype.snapshot.RelatedVersionType.Has_Previous_Version,  edu.mayo.ontology.taxonomies.kao.rel.relatedversiontype.snapshot.RelatedVersionType.Is_Later_Versioned_Revision_Of,  } ) 
   ;
  ...
  public static final URIIdentifier schemeURI = Series.toVersion(
      ...
      URI.create("https://ontology.mayo.edu/taxonomies/KAO/Rel/RelatedVersionType/SNAPSHOT/"));

  public static final NamespaceIdentifier namespace = new NamespaceIdentifier()
      .withId(URI.create("https://ontology.mayo.edu/taxonomies/KAO/Rel/RelatedVersionType/SNAPSHOT/"))
  ...
  public static class JsonSerializer extends LegacyURITermsJsonAdapter.Serializer<RelatedVersionType> {}

  public static class JsonDeserializer extends LegacyURITermsJsonAdapter.Deserializer<RelatedVersionType> {
