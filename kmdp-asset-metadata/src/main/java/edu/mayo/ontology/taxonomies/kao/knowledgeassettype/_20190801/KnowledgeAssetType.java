package edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801;
...
public enum KnowledgeAssetType implements edu.mayo.ontology.taxonomies.kao.knowledgeassettype.KnowledgeAssetType {
    ...
    Formal_Ontology( "https://ontology.mayo.edu/taxonomies/KAO/KnowledgeAssetType#f7f24acc-0954-3cc4-bc89-9760e4a3a219", "f7f24acc-0954-3cc4-bc89-9760e4a3a219", "FormalOntology", java.util.Arrays.asList( "FormalOntology" ), "Formal Ontology", "https://www.omg.org/spec/API4KP/api4kp-kao/FormalOntology",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Conceptual_Domain_Model,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Conceptual_Domain_Model,  } ) , 
    ...
    Decision_Task_Model( "https://ontology.mayo.edu/taxonomies/KAO/KnowledgeAssetType#b6d9833f-1d31-3851-918b-5e4c58da46cd", "b6d9833f-1d31-3851-918b-5e4c58da46cd", "DecisionTaskModel", java.util.Arrays.asList( "DecisionTaskModel" ), "Decision Task Model", "https://www.omg.org/spec/API4KP/api4kp-kao/DecisionTaskModel",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Cognitive_Process_Model,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Cognitive_Process_Model,  } ) , 
    ...
    Multi_Agent_Decision_Task_Model( "https://ontology.mayo.edu/taxonomies/KAO/KnowledgeAssetType#5c742ccc-fb77-3f33-87f5-663c2d9d251c", "5c742ccc-fb77-3f33-87f5-663c2d9d251c", "MultiAgentDecisionTaskModel", java.util.Arrays.asList( "MultiAgentDecisionTaskModel" ), "Multi-Agent Decision Task Model", "https://www.omg.org/spec/API4KP/api4kp-kao/MultiAgentDecisionTaskModel",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Decision_Task_Model,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Cognitive_Process_Model,  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Decision_Task_Model,  } ) , 
    ...
    Semantic_Information_Model( "https://ontology.mayo.edu/taxonomies/KAO/KnowledgeAssetType#58d7a7c1-4301-3361-90b0-f753ba6308f4", "58d7a7c1-4301-3361-90b0-f753ba6308f4", "SemanticInformationModel", java.util.Arrays.asList( "SemanticInformationModel" ), "Semantic Information Model", "https://www.omg.org/spec/API4KP/api4kp-kao/SemanticInformationModel",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Information_Model,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Information_Model,  } ) , 
    ...
    @de.escalon.hypermedia.hydra.mapping.Expose( "http://ontology.mayo.edu/ontologies/clinicalknowledgeassets/ClinicalRule" )
    Clinical_Rule( "https://ontology.mayo.edu/taxonomies/KAO/KnowledgeAssetType#85a69294-58d2-3fc2-b6b6-1603601b6b6d", "85a69294-58d2-3fc2-b6b6-1603601b6b6d", "ClinicalRule", java.util.Arrays.asList( "ClinicalRule" ), "Clinical Rule", "http://ontology.mayo.edu/ontologies/clinicalknowledgeassets/ClinicalRule",
        new Term[] {  },
        new Term[] {  } ) , 
    ...
    @de.escalon.hypermedia.hydra.mapping.Expose( "http://ontology.mayo.edu/ontologies/clinicalknowledgeassets/ClinicalPracticeGuideline" )
    Clinical_Practice_Guideline( "https://ontology.mayo.edu/taxonomies/KAO/KnowledgeAssetType#a145eccf-b803-3766-a23b-12accce04675", "a145eccf-b803-3766-a23b-12accce04675", "ClinicalPracticeGuideline", java.util.Arrays.asList( "ClinicalPracticeGuideline" ), "Clinical Practice Guideline", "http://ontology.mayo.edu/ontologies/clinicalknowledgeassets/ClinicalPracticeGuideline",
        new Term[] {  },
        new Term[] {  } ) , 
    ...
    Questionnaire( "https://ontology.mayo.edu/taxonomies/KAO/KnowledgeAssetType#179d692e-f970-3bcf-ad92-ff37fd394ec8", "179d692e-f970-3bcf-ad92-ff37fd394ec8", "Questionnaire", java.util.Arrays.asList( "Questionnaire" ), "Questionnaire", "https://www.omg.org/spec/API4KP/api4kp-kao/Questionnaire",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Documentation_Template,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Documentation_Template,  } ) , 
    ...
    @de.escalon.hypermedia.hydra.mapping.Expose( "http://ontology.mayo.edu/ontologies/clinicalknowledgeassets/ClinicalProtocol" )
    Clinical_Protocol( "https://ontology.mayo.edu/taxonomies/KAO/KnowledgeAssetType#ab6a0cf1-bf9b-3167-ab63-7855b33c002b", "ab6a0cf1-bf9b-3167-ab63-7855b33c002b", "ClinicalProtocol", java.util.Arrays.asList( "ClinicalProtocol" ), "Clinical Protocol", "http://ontology.mayo.edu/ontologies/clinicalknowledgeassets/ClinicalProtocol",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Protocol,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Protocol,  } ) , 
   
    /* Protocol that directs the behavior of nurses */
    @javax.xml.bind.annotation.XmlEnumValue("NursingProtocol")
    @de.escalon.hypermedia.hydra.mapping.Expose( "http://ontology.mayo.edu/ontologies/clinicalknowledgeassets/NursingProtocol" )
    Nursing_Protocol( "https://ontology.mayo.edu/taxonomies/KAO/KnowledgeAssetType#6047674c-0d9b-3c81-89a3-6943f3a7169b", "6047674c-0d9b-3c81-89a3-6943f3a7169b", "NursingProtocol", java.util.Arrays.asList( "NursingProtocol" ), "Nursing Protocol", "http://ontology.mayo.edu/ontologies/clinicalknowledgeassets/NursingProtocol",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Clinical_Protocol,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Clinical_Protocol,  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Protocol,  } ) , 
    ...
    @de.escalon.hypermedia.hydra.mapping.Expose( "http://ontology.mayo.edu/ontologies/clinicalknowledgeassets/ClinicalTrialProtocol" )
    Clinical_Trial_Protocol( "https://ontology.mayo.edu/taxonomies/KAO/KnowledgeAssetType#db61721f-b412-30cb-a8c9-571ec143e45b", "db61721f-b412-30cb-a8c9-571ec143e45b", "ClinicalTrialProtocol", java.util.Arrays.asList( "ClinicalTrialProtocol" ), "Clinical Trial Protocol", "http://ontology.mayo.edu/ontologies/clinicalknowledgeassets/ClinicalTrialProtocol",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Clinical_Protocol,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Clinical_Protocol,  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Protocol,  } ) , 
    ...
    Formal_Grammar( "https://ontology.mayo.edu/taxonomies/KAO/KnowledgeAssetType#ddbe6d71-1ed9-349f-a283-ce5b9f1a2e23", "ddbe6d71-1ed9-349f-a283-ce5b9f1a2e23", "FormalGrammar", java.util.Arrays.asList( "FormalGrammar" ), "formal grammar", "https://www.omg.org/spec/API4KP/api4kp/FormalGrammar",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Grammar,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Grammar,  } ) , 
    ...
    Vocabulary( "https://ontology.mayo.edu/taxonomies/KAO/KnowledgeAssetType#1dd8cd8a-f5f7-36dc-bb82-c583a35bd0bc", "1dd8cd8a-f5f7-36dc-bb82-c583a35bd0bc", "Lexicon", java.util.Arrays.asList( "Lexicon" ), "vocabulary", "https://www.omg.org/spec/API4KP/api4kp/Lexicon",
        new Term[] {  },
        new Term[] {  } ) , 
   
    /* A standardized list of orders for a specific diagnosis */
    @javax.xml.bind.annotation.XmlEnumValue("OrderSet")
    @de.escalon.hypermedia.hydra.mapping.Expose( "http://ontology.mayo.edu/ontologies/clinicalknowledgeassets/OrderSet" )
    Order_Set( "https://ontology.mayo.edu/taxonomies/KAO/KnowledgeAssetType#ec0813c7-748e-3c4f-ba9c-dd475f04f471", "ec0813c7-748e-3c4f-ba9c-dd475f04f471", "OrderSet", java.util.Arrays.asList( "OrderSet" ), "Order Set", "http://ontology.mayo.edu/ontologies/clinicalknowledgeassets/OrderSet",
        new Term[] {  },
        new Term[] {  } ) , 
    ...
    Decision_Model( "https://ontology.mayo.edu/taxonomies/KAO/KnowledgeAssetType#310adb96-1a21-3100-90eb-c7ef4fe270e7", "310adb96-1a21-3100-90eb-c7ef4fe270e7", "DecisionModel", java.util.Arrays.asList( "DecisionModel" ), "Decision Model", "https://www.omg.org/spec/API4KP/api4kp-kao/DecisionModel",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Assessment_Model,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Assessment_Model,  } ) , 
    ...
    Equation( "https://ontology.mayo.edu/taxonomies/KAO/KnowledgeAssetType#aa8a1050-43d9-3127-8760-e67170853c2c", "aa8a1050-43d9-3127-8760-e67170853c2c", "Equation", java.util.Arrays.asList( "Equation" ), "Equation", "https://www.omg.org/spec/API4KP/api4kp-kao/Equation",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Functional_Expression,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Functional_Expression,  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Assessment_Model,  } ) , 
    ...
    Computable_Decision_Model( "https://ontology.mayo.edu/taxonomies/KAO/KnowledgeAssetType#34de94f3-e2fe-3803-bc24-e508dfff3821", "34de94f3-e2fe-3803-bc24-e508dfff3821", "ComputableDecisionModel", java.util.Arrays.asList( "ComputableDecisionModel" ), "Computable Decision Model", "https://www.omg.org/spec/API4KP/api4kp-kao/ComputableDecisionModel",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Decision_Model,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Decision_Model,  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Assessment_Model,  } ) , 
    ...
    @de.escalon.hypermedia.hydra.mapping.Expose( "http://ontology.mayo.edu/ontologies/clinicalknowledgeassets/QualityMeasure" )
    Clinical_Quality_Measure( "https://ontology.mayo.edu/taxonomies/KAO/KnowledgeAssetType#4f2167ce-cfab-34cf-b97f-e37131e2a6b1", "4f2167ce-cfab-34cf-b97f-e37131e2a6b1", "QualityMeasure", java.util.Arrays.asList( "QualityMeasure" ), "Clinical Quality Measure", "http://ontology.mayo.edu/ontologies/clinicalknowledgeassets/QualityMeasure",
        new Term[] {  },
        new Term[] {  } ) , 
    ...
    Service_Profile( "https://ontology.mayo.edu/taxonomies/KAO/KnowledgeAssetType#c3a1659d-bcfb-3ee5-8965-72394890d15f", "c3a1659d-bcfb-3ee5-8965-72394890d15f", "ServiceProfile", java.util.Arrays.asList( "ServiceProfile" ), "Service Profile", "https://www.omg.org/spec/API4KP/api4kp-kao/ServiceProfile",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Service_Description,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Service_Description,  } ) , 
    ...
    @de.escalon.hypermedia.hydra.mapping.Expose( "http://ontology.mayo.edu/ontologies/clinicalknowledgeassets/CareProcessModel" )
    Care_Process_Model( "https://ontology.mayo.edu/taxonomies/KAO/KnowledgeAssetType#434e06c0-e3df-3e57-9862-144f7c7857c4", "434e06c0-e3df-3e57-9862-144f7c7857c4", "CareProcessModel", java.util.Arrays.asList( "CareProcessModel" ), "Care Process Model", "http://ontology.mayo.edu/ontologies/clinicalknowledgeassets/CareProcessModel",
        new Term[] {  },
        new Term[] {  } ) , 
    ...
    @de.escalon.hypermedia.hydra.mapping.Expose( "http://ontology.mayo.edu/ontologies/clinicalknowledgeassets/CognitiveCareProcessModel" )
    Cognitive_Care_Process_Model( "https://ontology.mayo.edu/taxonomies/KAO/KnowledgeAssetType#5ae45eed-8397-3431-a5f9-c963e3b5411d", "5ae45eed-8397-3431-a5f9-c963e3b5411d", "CognitiveCareProcessModel", java.util.Arrays.asList( "CognitiveCareProcessModel" ), "Cognitive Care Process Model", "http://ontology.mayo.edu/ontologies/clinicalknowledgeassets/CognitiveCareProcessModel",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Cognitive_Process_Model,  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Care_Process_Model,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Cognitive_Process_Model,  edu.mayo.ontology.taxonomies.kao.knowledgeassettype._20190801.KnowledgeAssetType.Care_Process_Model,  } ) 
   ;
  ...
  public static final URIIdentifier schemeURI = Series.toVersion(
      ...
      URI.create("https://ontology.mayo.edu/taxonomies/KAO/KnowledgeAssetType/20190801/"));

  public static final NamespaceIdentifier namespace = new NamespaceIdentifier()
      .withId(URI.create("https://ontology.mayo.edu/taxonomies/KAO/KnowledgeAssetType/20190801/"))
