...
public enum MIMEType implements edu.mayo.ontology.taxonomies.mimetype.IMIMEType {
  ...
  public static class JsonSerializer extends LegacyURITermsJsonAdapter.Serializer<MIMEType> {}

  public static class JsonDeserializer extends LegacyURITermsJsonAdapter.Deserializer<MIMEType> {
