...
public enum DependencyType implements edu.mayo.ontology.taxonomies.kao.rel.dependencyreltype.DependencyType {
    ...
    Imports( "https://ontology.mayo.edu/taxonomies/KAO/Rel/DependencyRelType#a6878bf5-d858-3676-83a1-ef2871d36f47", "a6878bf5-d858-3676-83a1-ef2871d36f47", "imports", java.util.Arrays.asList( "imports" ), "imports", "https://www.omg.org/spec/API4KP/api4kp/imports",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.dependencyreltype.snapshot.DependencyType.Depends_On,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.dependencyreltype.snapshot.DependencyType.Depends_On,  } ) , 
    ...
    Includes( "https://ontology.mayo.edu/taxonomies/KAO/Rel/DependencyRelType#bb2b21ef-7774-3f86-87ff-02b0284505c6", "bb2b21ef-7774-3f86-87ff-02b0284505c6", "includes", java.util.Arrays.asList( "includes" ), "includes", "https://www.omg.org/spec/API4KP/api4kp/includes",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.dependencyreltype.snapshot.DependencyType.Imports,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.dependencyreltype.snapshot.DependencyType.Imports,  edu.mayo.ontology.taxonomies.kao.rel.dependencyreltype.snapshot.DependencyType.Depends_On,  } ) 
   ;
  ...
  public static final URIIdentifier schemeURI = Series.toVersion(
      ...
      URI.create("https://ontology.mayo.edu/taxonomies/KAO/Rel/DependencyRelType/SNAPSHOT/"));

  public static final NamespaceIdentifier namespace = new NamespaceIdentifier()
      .withId(URI.create("https://ontology.mayo.edu/taxonomies/KAO/Rel/DependencyRelType/SNAPSHOT/"))
  ...
  public static class JsonSerializer extends LegacyURITermsJsonAdapter.Serializer<DependencyType> {}

  public static class JsonDeserializer extends LegacyURITermsJsonAdapter.Deserializer<DependencyType> {
