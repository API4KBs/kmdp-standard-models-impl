package edu.mayo.ontology.taxonomies.krprofile.snapshot;
...
public enum KnowledgeRepresentationLanguageProfile implements edu.mayo.ontology.taxonomies.krprofile.KnowledgeRepresentationLanguageProfile {
    ...
    GraphQL_Queries( "https://ontology.mayo.edu/taxonomies/KRProfile#f09564c9-ca56-350d-8cd6-b3319e541aee", "f09564c9-ca56-350d-8cd6-b3319e541aee", "Q", java.util.Arrays.asList( "Q" ), "GraphQL Queries", "https://graphql.github.io/graphql-spec/queries",
        new Term[] {  },
        new Term[] {  } ) , 
    ...
    GraphQL_Schemas( "https://ontology.mayo.edu/taxonomies/KRProfile#5dbc98dc-c983-3707-a8bd-082d1a47546e", "5dbc98dc-c983-3707-a8bd-082d1a47546e", "S", java.util.Arrays.asList( "S" ), "GraphQL Schemas", "https://graphql.github.io/graphql-spec/schemas",
        new Term[] {  },
        new Term[] {  } ) , 
  ...
  public static final URIIdentifier schemeURI = Series.toVersion(
      ...
      URI.create("https://ontology.mayo.edu/taxonomies/KRProfile/SNAPSHOT/"));

  public static final NamespaceIdentifier namespace = new NamespaceIdentifier()
      .withId(URI.create("https://ontology.mayo.edu/taxonomies/KRProfile/SNAPSHOT/"))
  ...
  public static class JsonSerializer extends LegacyURITermsJsonAdapter.Serializer<KnowledgeRepresentationLanguageProfile> {}

  public static class JsonDeserializer extends LegacyURITermsJsonAdapter.Deserializer<KnowledgeRepresentationLanguageProfile> {
