...
public enum LanguageSeries implements Language, Series<Language> {
  ...
  public static class JsonSerializer extends LegacyURITermsJsonAdapter.Serializer<Language> {

  }

  public static class JsonDeserializer extends LegacyURITermsJsonAdapter.Deserializer<Language> {
