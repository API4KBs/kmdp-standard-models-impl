package edu.mayo.ontology.taxonomies.lexicon.snapshot;
...
public enum Lexicon implements edu.mayo.ontology.taxonomies.lexicon.Lexicon {
  ...
  public static final URIIdentifier schemeURI = Series.toVersion(
      ...
      URI.create("https://ontology.mayo.edu/taxonomies/Lexicon/SNAPSHOT/"));

  public static final NamespaceIdentifier namespace = new NamespaceIdentifier()
      .withId(URI.create("https://ontology.mayo.edu/taxonomies/Lexicon/SNAPSHOT/"))
  ...
  public static class JsonSerializer extends LegacyURITermsJsonAdapter.Serializer<Lexicon> {}

  public static class JsonDeserializer extends LegacyURITermsJsonAdapter.Deserializer<Lexicon> {
