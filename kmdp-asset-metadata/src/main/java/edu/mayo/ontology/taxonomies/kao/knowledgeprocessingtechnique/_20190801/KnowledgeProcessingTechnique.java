package edu.mayo.ontology.taxonomies.kao.knowledgeprocessingtechnique._20190801;
...
public enum KnowledgeProcessingTechnique implements edu.mayo.ontology.taxonomies.kao.knowledgeprocessingtechnique.KnowledgeProcessingTechnique {
    ...
    Quantitative_Computational_Technique( "https://ontology.mayo.edu/taxonomies/KAO/KnowledgeProcessingTechnique#0453f3fa-9cfd-36cf-9a5a-1a17e0b7c29d", "0453f3fa-9cfd-36cf-9a5a-1a17e0b7c29d", "QuantitativeTechnique", java.util.Arrays.asList( "QuantitativeTechnique" ), "quantitative computational technique", "https://www.omg.org/spec/API4KP/api4kp-kao/QuantitativeTechnique",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeprocessingtechnique._20190801.KnowledgeProcessingTechnique.Computational_Technique,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeprocessingtechnique._20190801.KnowledgeProcessingTechnique.Computational_Technique,  } ) , 
    ...
    Logic_Based_Technique( "https://ontology.mayo.edu/taxonomies/KAO/KnowledgeProcessingTechnique#18c6c122-aa5a-3ec3-92cf-fcbc25d99dd6", "18c6c122-aa5a-3ec3-92cf-fcbc25d99dd6", "LogicBasedTechnique", java.util.Arrays.asList( "LogicBasedTechnique" ), "logic based technique", "https://www.omg.org/spec/API4KP/api4kp-kao/LogicBasedTechnique",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeprocessingtechnique._20190801.KnowledgeProcessingTechnique.Qualitative_Computational_Technique,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.knowledgeprocessingtechnique._20190801.KnowledgeProcessingTechnique.Computational_Technique,  edu.mayo.ontology.taxonomies.kao.knowledgeprocessingtechnique._20190801.KnowledgeProcessingTechnique.Qualitative_Computational_Technique,  } ) , 
  ...
  public static final URIIdentifier schemeURI = Series.toVersion(
      ...
      URI.create("https://ontology.mayo.edu/taxonomies/KAO/KnowledgeProcessingTechnique/20190801/"));

  public static final NamespaceIdentifier namespace = new NamespaceIdentifier()
      .withId(URI.create("https://ontology.mayo.edu/taxonomies/KAO/KnowledgeProcessingTechnique/20190801/"))
  ...
  public static class JsonSerializer extends LegacyURITermsJsonAdapter.Serializer<KnowledgeProcessingTechnique> {}

  public static class JsonDeserializer extends LegacyURITermsJsonAdapter.Deserializer<KnowledgeProcessingTechnique> {
