package edu.mayo.ontology.taxonomies.kao.rel.derivationreltype.snapshot;
...
public enum DerivationType implements edu.mayo.ontology.taxonomies.kao.rel.derivationreltype.DerivationType {
    ...
    Transliteration_Of( "https://ontology.mayo.edu/taxonomies/KAO/Rel/DerivationRelType#4201d317-b445-35e5-81cd-67b84105a3d8", "4201d317-b445-35e5-81cd-67b84105a3d8", "transliteration-of", java.util.Arrays.asList( "transliteration-of" ), "transliteration of", "https://www.omg.org/spec/API4KP/api4kp/transliteration-of",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.derivationreltype.snapshot.DerivationType.Derived_From,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.derivationreltype.snapshot.DerivationType.Derived_From,  } ) , 
    ...
    Digest_Of( "https://ontology.mayo.edu/taxonomies/KAO/Rel/DerivationRelType#f896008d-227b-32d1-a8f9-ea74f4adab7f", "f896008d-227b-32d1-a8f9-ea74f4adab7f", "digest-of", java.util.Arrays.asList( "digest-of" ), "digest of", "https://www.omg.org/spec/API4KP/api4kp/digest-of",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.derivationreltype.snapshot.DerivationType.Summarization_Of,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.derivationreltype.snapshot.DerivationType.Summarization_Of,  edu.mayo.ontology.taxonomies.kao.rel.derivationreltype.snapshot.DerivationType.Derived_From,  } ) , 
    ...
    Linguistic_Adaptation_Of( "https://ontology.mayo.edu/taxonomies/KAO/Rel/DerivationRelType#9f4fccf7-15ec-3373-aa05-0b7169837777", "9f4fccf7-15ec-3373-aa05-0b7169837777", "linguistic-adaptation-of", java.util.Arrays.asList( "linguistic-adaptation-of" ), "linguistic adaptation of", "https://www.omg.org/spec/API4KP/api4kp/linguistic-adaptation-of",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.derivationreltype.snapshot.DerivationType.Adaptation_Of,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.derivationreltype.snapshot.DerivationType.Adaptation_Of,  edu.mayo.ontology.taxonomies.kao.rel.derivationreltype.snapshot.DerivationType.Derived_From,  } ) , 
    ...
    Is_Later_Versioned_Revision_Of( "https://ontology.mayo.edu/taxonomies/KAO/Rel/DerivationRelType#ecd53a6e-ab42-3faf-ad05-0105822056ee", "ecd53a6e-ab42-3faf-ad05-0105822056ee", "is-later-versioned-revision-of", java.util.Arrays.asList( "is-later-versioned-revision-of" ), "is later versioned revision of", "https://www.omg.org/spec/API4KP/api4kp/is-later-versioned-revision-of",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.derivationreltype.snapshot.DerivationType.Is_Later_Revision_Of,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.derivationreltype.snapshot.DerivationType.Derived_From,  edu.mayo.ontology.taxonomies.kao.rel.derivationreltype.snapshot.DerivationType.Is_Later_Revision_Of,  } ) , 
    ...
    Is_Immediate_Next_Versioned_Revision_Of( "https://ontology.mayo.edu/taxonomies/KAO/Rel/DerivationRelType#e8c9e53c-b211-362b-bed8-b2144821a266", "e8c9e53c-b211-362b-bed8-b2144821a266", "is-immediate-next-versioned-revision-of", java.util.Arrays.asList( "is-immediate-next-versioned-revision-of" ), "is immediate next versioned revision of", "https://www.omg.org/spec/API4KP/api4kp/is-immediate-next-versioned-revision-of",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.derivationreltype.snapshot.DerivationType.Is_Later_Versioned_Revision_Of,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.derivationreltype.snapshot.DerivationType.Is_Later_Versioned_Revision_Of,  edu.mayo.ontology.taxonomies.kao.rel.derivationreltype.snapshot.DerivationType.Derived_From,  edu.mayo.ontology.taxonomies.kao.rel.derivationreltype.snapshot.DerivationType.Is_Later_Revision_Of,  } ) , 
    ...
    Imitation_Of( "https://ontology.mayo.edu/taxonomies/KAO/Rel/DerivationRelType#d995acdf-6cd1-3feb-bc86-228fa0be1b29", "d995acdf-6cd1-3feb-bc86-228fa0be1b29", "imitation-of", java.util.Arrays.asList( "imitation-of" ), "imitation of", "https://www.omg.org/spec/API4KP/api4kp/imitation-of",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.derivationreltype.snapshot.DerivationType.Inspired_By,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.derivationreltype.snapshot.DerivationType.Derived_From,  edu.mayo.ontology.taxonomies.kao.rel.derivationreltype.snapshot.DerivationType.Inspired_By,  } ) , 
    ...
    Compression_Of( "https://ontology.mayo.edu/taxonomies/KAO/Rel/DerivationRelType#d156995d-4e23-36b9-823b-e6780cab563f", "d156995d-4e23-36b9-823b-e6780cab563f", "compression-of", java.util.Arrays.asList( "compression-of" ), "compression of", "https://www.omg.org/spec/API4KP/api4kp/compression-of",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.derivationreltype.snapshot.DerivationType.Transcodification_Of,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.derivationreltype.snapshot.DerivationType.Derived_From,  edu.mayo.ontology.taxonomies.kao.rel.derivationreltype.snapshot.DerivationType.Transcodification_Of,  } ) 
   ;
  ...
  public static final URIIdentifier schemeURI = Series.toVersion(
      ...
      URI.create("https://ontology.mayo.edu/taxonomies/KAO/Rel/DerivationRelType/SNAPSHOT/"));

  public static final NamespaceIdentifier namespace = new NamespaceIdentifier()
      .withId(URI.create("https://ontology.mayo.edu/taxonomies/KAO/Rel/DerivationRelType/SNAPSHOT/"))
  ...
  public static class JsonSerializer extends LegacyURITermsJsonAdapter.Serializer<DerivationType> {}

  public static class JsonDeserializer extends LegacyURITermsJsonAdapter.Deserializer<DerivationType> {
