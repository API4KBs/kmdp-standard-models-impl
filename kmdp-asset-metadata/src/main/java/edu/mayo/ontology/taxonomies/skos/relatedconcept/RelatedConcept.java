...
public enum RelatedConcept implements edu.mayo.ontology.taxonomies.skos.relatedconcept.IRelatedConcept {
  ...
  public static class JsonSerializer extends LegacyURITermsJsonAdapter.Serializer<RelatedConcept> {}

  public static class JsonDeserializer extends LegacyURITermsJsonAdapter.Deserializer<RelatedConcept> {
