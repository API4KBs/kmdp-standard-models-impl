...
public enum RelatedConceptSeries implements IRelatedConcept, Series<IRelatedConcept> {
  ...
  public static class Adapter extends LegacyTermsXMLAdapter {
    public static final LegacyTermsXMLAdapter instance = new RelatedConceptSeries.Adapter();
    protected RelatedConceptSeries[] getValues() { return values(); }
  }


  public static class JsonSerializer extends LegacyURITermsJsonAdapter.Serializer<IRelatedConcept> {

  }

  public static class JsonDeserializer extends LegacyURITermsJsonAdapter.Deserializer<IRelatedConcept> {
