package edu.mayo.ontology.taxonomies.kao.rel.summaryreltype._20190801;
...
public enum SummarizationType implements edu.mayo.ontology.taxonomies.kao.rel.summaryreltype.SummarizationType {
    ...
    Compression_Of( "https://ontology.mayo.edu/taxonomies/KAO/Rel/SummaryRelType#d156995d-4e23-36b9-823b-e6780cab563f", "d156995d-4e23-36b9-823b-e6780cab563f", "compression-of", java.util.Arrays.asList( "compression-of" ), "compression of", "https://www.omg.org/spec/API4KP/api4kp/compression-of",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.summaryreltype._20190801.SummarizationType.Compact_Representation_Of,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.summaryreltype._20190801.SummarizationType.Compact_Representation_Of,  } ) , 
    ...
    Digest_Of( "https://ontology.mayo.edu/taxonomies/KAO/Rel/SummaryRelType#f896008d-227b-32d1-a8f9-ea74f4adab7f", "f896008d-227b-32d1-a8f9-ea74f4adab7f", "digest-of", java.util.Arrays.asList( "digest-of" ), "digest of", "https://www.omg.org/spec/API4KP/api4kp/digest-of",
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.summaryreltype._20190801.SummarizationType.Summarization_Of,  },
        new Term[] {  edu.mayo.ontology.taxonomies.kao.rel.summaryreltype._20190801.SummarizationType.Summarization_Of,  edu.mayo.ontology.taxonomies.kao.rel.summaryreltype._20190801.SummarizationType.Compact_Representation_Of,  } ) , 
  ...
  public static final URIIdentifier schemeURI = Series.toVersion(
      ...
      URI.create("https://ontology.mayo.edu/taxonomies/KAO/Rel/SummaryRelType/20190801/"));

  public static final NamespaceIdentifier namespace = new NamespaceIdentifier()
      .withId(URI.create("https://ontology.mayo.edu/taxonomies/KAO/Rel/SummaryRelType/20190801/"))
  ...
  public static class JsonSerializer extends LegacyURITermsJsonAdapter.Serializer<SummarizationType> {}

  public static class JsonDeserializer extends LegacyURITermsJsonAdapter.Deserializer<SummarizationType> {
