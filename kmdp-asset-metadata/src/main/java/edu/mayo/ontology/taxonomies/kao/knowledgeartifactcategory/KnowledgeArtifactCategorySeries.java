...
public enum KnowledgeArtifactCategorySeries implements IKnowledgeArtifactCategory, Series<IKnowledgeArtifactCategory> {
  ...
  public static class Adapter extends edu.mayo.kmdp.terms.adapters.xml.TermsXMLAdapter {
    public static final edu.mayo.kmdp.terms.adapters.xml.TermsXMLAdapter instance = new KnowledgeArtifactCategorySeries.Adapter();
    protected KnowledgeArtifactCategorySeries[] getValues() { return values(); }
  }


  public static class JsonSerializer extends edu.mayo.kmdp.terms.adapters.json.URITermsJsonAdapter.Serializer<IKnowledgeArtifactCategory> {

  }

  public static class JsonDeserializer extends edu.mayo.kmdp.terms.adapters.json.URITermsJsonAdapter.Deserializer<IKnowledgeArtifactCategory> {
